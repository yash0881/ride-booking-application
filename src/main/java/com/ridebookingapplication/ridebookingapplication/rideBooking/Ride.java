...
public class Ride {
    ...
    public Ride(int rideId, int userId, float distance, int stops, String vehicleNumber, VehicleType vehicleType, AreaType areaType, boolean isPeak, String city, double totalFare) {
        this.rideId = rideId;
        this.userId = userId;
